                        ...
                        <div class="card mx-auto p-2 float-start text-center" style="width: 30rem;">
                            ...
                            <div id="carouselExample" class="carousel slide">
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active">
                                        <img width="480px" height="480px" src="data:image/jpeg;base64,${photo}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="btn-group" role="group" aria-label="Basic outlined example">
                                    <form action="/user/post/like" method="post">
                                        <input type="hidden" value="${postDto.postUUID}" name="postUUID">
                                    ...
                                    <form action="/user/post/dislike" method="post">
                                        <input type="hidden" value="${postDto.postUUID}" name="postUUID">
                                        <button type="submit" class="btn btn-outline-primary">
