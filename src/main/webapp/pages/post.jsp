...
<div class="card mx-auto p-2" style="width: 30rem;">
    ...
    <div id="carouselExample" class="carousel slide">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="${linkimage1}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="${linkimage2}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="${linkimage3}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="${linkimage4}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="${linkimage5}" class="d-block w-100" alt="...">
            </div>
        </div>
    ...
    <p class="card-text text-start">${posttext}</p>
